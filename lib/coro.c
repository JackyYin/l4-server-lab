 ...
 */
__attribute__ ((naked, noinline, visibility("internal"))) void swap_context(co_context *old_context, co_context *new_context);
asm (
    ".globl swap_context\n\t"
    "swap_context:\n\t"
...
__attribute__ ((visibility("internal"))) void entry_point(coroutine * co, co_func func, void *data)
{
